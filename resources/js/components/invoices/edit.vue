        ...
        <div class="card__content">
            <div class="card__content--header">
                <div>
                    ...
                    <select name="" id="" class="input" v-model="form.customer_id">
                        ...
                        <option :value="customer.id" v-for="customer in allcustomers">{{ customer.firstname }}</option>
                    </select>
                </div>
                <div>
                    <p class="my-1">Date</p> 
            ...
            <div class="table">
                ...
                <div class="table--items2" v-for="(itemcart,i) in form.invoice_items" :key="itemcart.id">
                    <p v-if="itemcart.product">#{{itemcart.product.item_code}} {{itemcart.product.description}} 093654 vjxhchkvhxc vkxckvjkxc jkvjxckvjkx </p>
                    <p v-else>
            ...
            <div class="modal__items">
                <ul style="list-style: none;">
                    <li v-for="(item,i) in listproducts" :key="item.id" style="display: grid; grid-template-columns: 30px 350px 15px; align-items: center; padding-bottom: 5px;">
                        ...
                        <button @click="addCart(item)" style="border:1px solid #e0e0e0; width: 35px;">+</button>
                    </li>        
                </ul>
            </div>
            <br><hr>
